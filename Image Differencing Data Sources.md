...
1.  Go to [NOAA Climate Data Online
    Search](https://www.ncdc.noaa.gov/cdo-web/search)
...
Download NOAA Soil Moisture Data \[DEPRECATED: No longer needed\]:

1.  Notes before getting started

    1.  The data is from NOAA / NIDIS (National Integrated Drought
        Information System)

    2.  [Data
        information](https://www.drought.gov/data-maps-tools/cpc-soil-moisture)
        – Climate Prediction Center Soil Moisture Products

        1.  [How the data is
            calculated](https://www.cpc.ncep.noaa.gov/soilmst/glb/descrip.htm)

    3.  For one off visualizations of historic soil moisture use the
        [Climate Prediction Center Data
        Viewer](https://www.cpc.ncep.noaa.gov/products/Soilmst_Monitoring/US/Soilmst/Soilmst.shtml)

    4.  This tutorial will use FTP to do a bulk download, but individual
        soil moisture rasters can be downloaded from the [Climate
        Prediction Center FTP
        Website](https://ftp.cpc.ncep.noaa.gov/GIS/USDM_Products/soil/)

2.  Download [FileZilla](https://filezilla-project.org/)

3.  Open [this
    link](ftp://ftp.cpc.ncep.noaa.gov/GIS/USDM_Products/soil/) in your
    browser, and select FileZilla as the application to open the link
    with

4.  Under “Local Site” select the destination folder  
    Under “Remote Site” find “/GIS/USDM\_Products/soil” and right click
    the soil folder and press download

Download [USGS Landsat 8/9 SWIR
Data](https://www.usgs.gov/faqs/what-are-best-landsat-spectral-bands-use-my-research):
