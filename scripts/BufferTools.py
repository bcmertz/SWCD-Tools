...
class PointPlots:
    ...
    def execute(self, parameters, messages):
        ...
        scratch_dissolve = arcpy.CreateUniqueName("scratch_dissolve.shp", workspace=arcpy.env.scratchFolder)
        scratch_buffer = arcpy.CreateUniqueName("scratch_buffer.shp", workspace=arcpy.env.scratchFolder)
